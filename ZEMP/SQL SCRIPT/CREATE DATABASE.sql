...
--PHAN QUYEN USER
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = N'ZEMP_CF_MODE')
BEGIN
  DROP TABLE [dbo].[ZEMP_CF_MODE]
END
GO
SET ANSI_NULLS ON
GO
...
GO
--CREATE TABLE 
CREATE TABLE ZEMP_CF_MODE(
	[SystemId]	[varchar](15)	NOT NULL,
	[Mode]		[varchar](20)	NOT NULL,
	[DienGiai]	[nvarchar](50)	NOT NULL,
	[STT]		int				NOT NULL,
	CONSTRAINT [PK_ZEMP_CF_MODE] PRIMARY KEY CLUSTERED (
	 [SystemId] ASC ,
	 [Mode]		ASC
	 )
WITH (	PAD_INDEX = OFF, 
